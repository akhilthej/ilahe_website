  ...
  return (
    <div className="container mx-auto antialiased text-gray-900 bg-white">
          ...
          {plans.map((plan, i) => (
            <section key={i} className="flex flex-col w-full max-w-sm p-12 space-y-6 bg-white rounded-lg shadow-md">
              ...
              <div className="flex-shrink-0">
                ...
                <span className="text-gray-400" x-text={billPlan === 'monthly' ? '/month' : '/year'}></span>
              </div>
      ...
      <div className="fixed flex items-center space-x-4 bottom-5 left-5">
        <a href="https://twitter.com/ak_kamona" target="_blank" className="transition-transform transform hover:scale-125">

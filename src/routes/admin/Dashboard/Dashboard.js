  ...
  return (
    <>
      {!isLoggedIn ? (
        ...
        <div className="flex sm:flex-row flex-col space-y-2 sm:space-x-2 flex-row w-full items-center justify-center min-h-screen">    
      ...
      <div>
        ...
        <div className="font-bold text-sm">Site Expires on</div>
      </div>
    </div>
